...
import { createWebhook, deleteWebhook, enqueueWebhookTestDelivery, getWebhook, getWebhookDelivery, listDeadLetterDeliveries, listSupportedWebhookEvents, listWebhookDeliveries, listWebhooks, normalizeWebhookEvents, purgeDeadLetterDeliveries, retryWebhookDelivery, updateWebhook, } from '../services/webhooks.js';
...
router.patch('/:id', (req, res) => {
    ...
    if ('instance' in body)
        patch.instance = body.instance != null ? String(body.instance).trim() : undefined;
    if ('secret' in body)
        patch.secret = body.secret != null ? String(body.secret).slice(0, 256) : undefined;
