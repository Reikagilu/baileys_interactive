...
import { parseChatwootWebhook, invalidateConversationCache, autoCreateChatwootInbox, syncHistoryToChatwoot } from './services/chatwoot-bridge.js';
...
app.get('/v1/media/:instance/:mediaId', (req, res) => {
    ...
    const verification = verifyMediaUrlToken(config.media.signedUrlSecret, instance, mediaId, req.query.exp, req.query.sig);
    if (!verification.ok) {
        const verErr = verification.error;
