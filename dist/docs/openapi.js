...
function okResponseWithExample(example) {
    return {
        description: 'Successful response',
        content: {
            'application/json': {
...
function errorResponseWithExample(example) {
    return {
        description: 'Error response',
        content: {
            'application/json': {
...
export const openApiSpec = {
    ...
    info: {
        title: 'Beyound API',
        version: '1.0.0',
        description: 'API para gerenciamento de multiplas instancias WhatsApp, mensageria, webhooks, operacoes e integracoes por instancia.',
    },
    servers: [{ url: '/' }],
    tags: [
