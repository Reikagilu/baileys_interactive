...
export const config = {
    ...
    webhooks: {
        ...
        includeIncomingMediaBase64: parseBoolean(process.env.WEBHOOK_INCLUDE_INCOMING_MEDIA_BASE64 ?? process.env.WEBHOOK_INCLUDE_INCOMING_AUDIO_BASE64, false),
        includeIncomingVideoBase64: parseBoolean(process.env.WEBHOOK_INCLUDE_INCOMING_VIDEO_BASE64, false),
        incomingMediaBase64MaxBytes: parseNumber(process.env.WEBHOOK_INCOMING_MEDIA_BASE64_MAX_BYTES ?? process.env.WEBHOOK_INCOMING_AUDIO_BASE64_MAX_BYTES, 2 * 1024 * 1024, 1024),
    ...
    limits: {
        ...
        chatMediaRetentionMs: parseNumber(process.env.CHAT_MEDIA_RETENTION_MS ?? process.env.CHAT_MEDIA_TTL_MS, 90 * 24 * 60 * 60 * 1000, 60 * 1000),
    },
};
